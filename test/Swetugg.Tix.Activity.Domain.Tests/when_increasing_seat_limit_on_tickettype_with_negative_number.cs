...
{
    public class when_increasing_seat_limit_on_tickettype_with_negative_number : with_activity
    {
        public when_increasing_seat_limit_on_tickettype_with_negative_number(ITestOutputHelper output) : base(output)
        {
        }
