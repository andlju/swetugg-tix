...
{
    public abstract class OrderAdminCommandFunc<TCommand> where TCommand : OrderAdminCommand, new()
    {
        private readonly IMessageSender _sender;

        protected OrderAdminCommandFunc(IOrderCommandMessageSender sender)
        {
            _sender = sender;
        }
